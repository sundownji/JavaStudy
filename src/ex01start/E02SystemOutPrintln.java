...
print(): 출력 후 줄바꿈 처리하지않는다. 만약 줄바꿈이 필요하면 \n을 추가해야한다.
printf(): 출력 내용을 서식에 맞춰서 출력한다. 
...
public class E02SystemOutPrintln {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 2.문자열, 숫자 등 서로 성격이 다른 데이터끼리는 단순 연결하는
		 	기능만 제공한다.
		*/
		//둘 다 정수이므로 덧셈연산이 된다.
		...
		/* 
		숫자(정수 혹은 실수)와 문자열 혹은 문자열과 문자열인 경우에는 단순 연결해서 출력
		*/
		...
		*/
		...
		//jvm - 자바 기반 프로그램 
		//자료 정의 딱 맞는 걸 넣었다
		//자바스크립트 파이썬 num 지정하면 크기를 엄청 넓게 지정
		//자바 바이트는 딱 맞는 용량을 지정
