...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		/*
		자동형변환:작은 자료형의 데이터를 큰자료형에 대입할 때 자동으로
		 형변환이 일어난다. byte>short>int>long
		*/
		byte b1 =65;
		short s1;
		...
		/*
		아래 코드는 자동형변환이 아니다. CPU는 int보다 작은 자료를 연산할때는
...
//		char ch1 = b1;
		...
		*/
		...
		//프로그램적인 오류로 인해 한바퀴 돌아서 -127이 나오는 것임
		short s2 =100;
		byte b2 =(byte)s2;
		...
		*/
		...
		double dl =3.14;
		num3 = (int)dl;
		//서식문자 사용시 %.2f는 정수부 모두 출력하고, 소수 이하는 2자리까지만 표현
		System.out.printf("데이터손실:num3=%d, dl=%.2f%n", num3, dl);
		
		/*
		문자는 메모리에 저장시 아스키코드로 저장되므로 int형과의 연산을 진행한 후
