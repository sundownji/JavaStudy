...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		'(Single quotation)으로 감싸서 표현해야한다.
		만약 "(Double quotation)으로 감싸면 문자열로 인식하므로 String으로 선언해야한다. 
		<자바에서 대문자로 쓴 글씨 있으면 클래스라고 생각하셈>
		*/
		char ch1 ='가';
...
//		char chStr ='가나다라';
		...
		/*
		아스키코드:1바이트로 표현할 수 있는 문자로 영문,숫자를 십진수로 정의한 것을 말한다.
		 EX) A => 65, a=>97로 표현된다.
		유니코드:1바이트로 표현할 수 없는 문자로 영문과 숫자를 제외한 모든 문자(한글,한자 등)을 
	 		2바이트로 표현한다. 보통 숫자가 크기 때문에 16진수로 표현한다.
		*/
		...
		//싱글쿼테이션으로 1을 감쌌기 때문에 문자1(아스키코드:49)이 할당
		char ch4 ='1';
		...
		//boolean 타입 :true or false 두가지의 값만 가질 수 있는 자료형으로
