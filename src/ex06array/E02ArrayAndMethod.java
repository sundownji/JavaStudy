...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		배열 인스턴스의 주소값을 int형 배열변수인 arr(stack)에 할당하게된다. */
		int[] arr = {1,2,3,4,5};
		...
		System.out.println();
		//배열명을 인수로 전달하는 것은 배열의 참조값(주소값)을 전달하는 것으로 배열
		//자체가 전달되지 않는다. 아래 출력문에서는 배열 인스턴스의 참조값(주소값)이 출력된다.
	...
	static int[] addAllArray(int[] ar, int addVal) {
		//배열의 각 인덱스에 매개변수로 전달된 7을 더해준다. 각 원소를 7씩 증가시킨다.
