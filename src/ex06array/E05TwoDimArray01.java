package ex06array;
//빈공간 null로 초기화된다. 0은 아스키코드를 갖고 있고, space도 아스키값이 있어서 null이 찐으로 없을 무다.
//[]한개만 쓰면 크기가 출력되고, [] [] 두개 쓰면 위치가 출력된다.
public class E05TwoDimArray01 {
	...
	public static void main(String[] args) {
		...
		*null값: 아무것도 없는 값을 일컫는다. 즉 빈값을 말한다.
		...
		<각 행마다 원소의 갯수가 다르다는게 조곰 문제 그래서 가장 큰 쪽에 맞춰야 함>  
		*/
		int[][] arr = {
				{1,2},
				{3,4,5},
		...
		(배열의 인덱스를 초과했다는 예외가 발생하게 된다.)*/
		System.out.println("배열 출력하기");
		System.out.println("arr[0][1]="+arr[0][1]);
		//0,3까지 밖에 안되기 때문에 출력 안되고, 이 코드가 위에있으면 다음 코드가 진행
		//안된다고 한다.
