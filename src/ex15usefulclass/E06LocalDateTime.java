...
public class E06LocalDateTime {
	...
	public static void main(String[] args) {
		 ...
		 * getMonths(),getDays() 메서드를 통해 남은 개월수와 날짜를 얻어올 수 있다.*/
		...
		//현재를 기준으로 이전/이후의 날짜를 구할 수 있다. //남은 전체 일수를 표시한다.
		System.out.println("5일전 :"+ monent.minusDays(5)); //5일전
		System.out.println("3일후 :"+ monent.plusDays(3)); //3일후
		System.out.println("2개월후 :"+ monent.plusMonths(2)); //2개월 후
		System.out.println("1년후:" + monent.plusYears(1));//1년 후
