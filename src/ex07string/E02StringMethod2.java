...
public class E02StringMethod2 {
	...
	public static void main(String[] args) {
		...
		/*6]codePointAt():문자열의 특정 인덱스의 문자를 찾은 후 아스키코드를 반환한다.*/
		...
		/*7]endsWith() 8]startsWith()
		 :특정문자열로 끝나면 true,특정문자열로 시작될때 true를 반환한다.*/
