...
//		if(str2.charAt(7)=='2'||)
		...
		System.out.println("str3의 이메일 형식 확인:"+str3.contains("net"));
		System.out.println("str3에 @과.net이 있기 때문에 이메일 형식이 맞다.");
		System.out.println("str4의 이메일 형식 확인:"+str4.contains("com"));
		System.out.println("str4는 .com이 없기 때문에 이메일 형식이 아니다.");
	
		System.out.println("=====3번=====");
		//만약에 사용자가 쓴 숫자로 판단하는걸로 만들려면 어떻게 만들어야 할꽈
		System.out.println((str1.indexOf("3")!=-1) ? "남성": "여성");
		System.out.println((str2.indexOf("4")!=-1)? "여성":"남성");
		
		System.out.println("=====4번=====");
		
		String str5 ="my.file.images.jpg";
		System.out.println(str5.lastIndexOf("."));
		System.out.println(str5.substring(14));
