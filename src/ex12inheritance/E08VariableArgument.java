...
//	}
	...
	/* ...을 통해 매개변수 param이 2개이상의 인수를 받을 수 있는 것을 명시한다.
	   또한 메서드 내에서는 배열로 반환되어 매개변수명.length와 같이 사용할 수 있다. */
	static int getTotal(int ... param) {
		int total = 0;
		//전달된 매개변수의 크기만큼 반복하여 누적해서 더 해줌
	...
	public static void main(String[] args) {
		...
		/* 매개변수 타입이 double이 포함되어 있으므로 호출할 수 없다. 만약 아래와 같이
		   실수를 모두 처리하려면 가변인자의 타입을 double로 선언하면 된다. */
