...
/* public 클래스는 해당 Java파일을 대표하는 클래스로 파일명과 동일해야 한다.
 	...
 	하나의 Java 파일에 하나의 class만 정의하는 것을 권장한다. */
public class E01AccessModifier1 {

	//멤버변수: 3가지의 접근지정자를 통해 선언 
	//하나의 멤버(가족)이기 때문에 멤버메서드에서 사용해도 영향을 받지 않음
