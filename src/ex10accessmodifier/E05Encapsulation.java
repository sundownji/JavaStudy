...
class EncapsulLogic {
	...
	void doProcess() {
		...
		firstLoginEvent.doFirstLoginEvent(); //3.이벤트페이지
		congratulationPoint.doCongratulationPoint(); //4.가입축하
	}
}
public class E05Encapsulation {
	...
	public static void main(String[] args) {
		...
		//맛집 가는 곳 적어주지 않고 말로만 설명한거라고 생각하라
		...
		congratulationPoint.doCongratulationPoint(); //축하포인트 페이지
